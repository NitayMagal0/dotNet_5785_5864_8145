...
//        AssignmentManager.PeriodicAssignmentsUpdates(oldClock, newClock); //stage 4        //etc ...
...
internal static class AdminManager //stage 4
{
    ...
    public static void ThrowOnSimulatorIsRunning()
    {
        if (s_thread is not null)
            throw new DalInvalidOperationException("Cannot perform the operation since Simulator is running");
    }
