...
internal static class ClockManager //stage 4
{
    ...
    private static void updateClock(DateTime newClock) // prepared for stage 7 as DRY to eliminate needless repetition
    {
        ...
        //StudentManager.PeriodicStudentsUpdates(oldClock, newClock); //stage 4                          //NEED TO CHANGE HERE 
        //etc ...
    ...
    private static void clockRunner()
    {
        while (!s_stop)
        {
            ...
            //StudentManager.SimulateCourseRegistrationAndGrade(); //stage 7                //I COMMENTED THIS SO WE CAN RUN THE PROGRAM
